...
---------------------------------------Alleyway--------------------------------------
--Future conditional, event will only occur once
...
--future conditional, won't show up if event already occured
--Choice-1
...
Guard(aside): "Esos malditos ingleses..."');
INSERT INTO choice (id, eventid, text, actionid) VALUES (389, 388, 'Set sail!', 390);
INSERT INTO actions (id, text) VALUES (390, 'I probably shouldn`t head back there');
INSERT INTO actionsevent (actionid, eventid, eventposition) VALUES (390, 1500, 0);