...
# INSERT INTO actionsevent (actionid, eventid, eventposition) VALUES (11CC, 11DD, 0); ## 1103 is the next event id
#
########################################################################################################################
#
# Display Text with "Next" Choice only (do not change background or music)
#
...
# INSERT INTO actionsevent (actionid, eventid, eventposition) VALUES (11CC, 11YY, 0);
#
###Choice 2
...
# INSERT INTO actionsevent (actionid, eventid, eventposition) VALUES (11EE, 11ZZ, 0);
#
########################################################################################################################
...
#
# Display Text with "Next" Choice only (do not change background and music)
# INSERT INTO event(id, text) VALUES (11AA, 'The coordinantes match up.  This must be the island!');
# INSERT INTO choice(id, eventid, text, actionid) VALUES (11BB, 11AA, 'next', 11CC);
# INSERT INTO actions(id) VALUES (11CC);
# INSERT INTO actionsevent (actionid, eventid, eventposition) VALUES (11CC, 11DD, 0);
#
#
########################################################################################################################
#
