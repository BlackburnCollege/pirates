...
INSERT INTO event(id, text) VALUES (701, 'Robert Knight said that the Kalinago people, who live on this island, were most likely to have the map. I should be careful though, because they are known to be unkind to outsiders.')
--
-- Choice 1
...
------------------------------------------------------------------------------------------------------------------------
--
  INSERT INTO event(id,text) VALUES (702, 'As I approach the village quietly, I see the villagers dancing and celebrating in the center of the village. On the left side of the village appears to be a temple and to the right is a cluster of huts.');
--
-- Choice 1
...
------------------------------------------------------------------------------------------------------------------------
--
INSERT INTO event(id, text) VALUES (704, 'I duck into the nearest hut, but the footsteps keep getting closer until a Kalingo man enters the hut. ‘What are you doing here?!’ he angrily yells. He drags me outside and the leader of the village is waiting.');
...
------------------------------------------------------------------------------------------------------------------------
--
INSERT INTO event(id, text) VALUES (705, 'You quickly move behind the nearest hut until you hear the footsteps disappear into the hut. You go into the temple and a shrine to Mabouya, the evil spirit that the Kalinago worship, is in the center. You see that one of the items in the shrine is the map piece you are looking for. You grab the piece and hurry out of the temple. Halfway back to the boat, you start to hear shouts and turn to see a group of Kalinago coming toward you');
--
--Choice 1
...
------------------------------------------------------------------------------------------------------------------------
--
INSERT INTO event(id, text) VALUES (710, 'I can help Mabouya, though!” The men look at each other and the leader of the group finally speaks, “There is one thing that you can do to help us. There is a flower called the Pagua that grows on the top of the mountain on this island. It is a white flower with a heavenly scent. It’s bloom is very rare, but if you can capture one, we will give you your map piece.');
--
--Choice 1
...
------------------------------------------------------------------------------------------------------------------------
--
INSERT INTO event(id, text) VALUES (713, 'I manage to fight my way to the map, grab it, and I run back to my boat. I take off, hearing the angry tribesmen yelling behind me.');
...
------------------------------------------------------------------------------------------------------------------------
--
INSERT INTO event(id, text) VALUES (714, 'After losing the fight, I manage to flee and lose them. I’m going to have to sneak through the woods to find the map piece.');
