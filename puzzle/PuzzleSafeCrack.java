...
public class PuzzleSafeCrack extends PuzzleModel {
  ...
  /**
   * private modifier restricts other programs, subclasses in this package, and
   * different packages from accessing these variables directly
   */
  ...
  /**
   * private modifier restricts other programs, subclasses in this package, and
   * different packages from accessing this method directly
   *
  ...
  /**
   * turnCounterClockwise is called by the controller when the player turns the
